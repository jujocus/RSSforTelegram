...
Modifica el .py para especificar las palabras claves que quiere que mire en google news, y el .yml en .github/workflows para cambiarle el nombre. Debes clonar en tu propio github este repositorio.
...
7. Finalmente, ve a Actions (arriba, debajo de RSSforTelegram), a la izquierda verás el nombre de la acción del .yml.
